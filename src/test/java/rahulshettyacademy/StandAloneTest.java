...
public class StandAloneTest {
    public static void main(String[] args) {
        ...
        // Find the email field using its 'id' attribute and type the email
        WebElement emailField = driver.findElement(By.id("userEmail"));
        emailField.sendKeys("phil@hotmail.com");

        // Find the password field using its 'id' attribute and type the password
        WebElement passwordField = driver.findElement(By.id("userPassword"));
        passwordField.sendKeys("Klm9000!");

        // Find the login button using its 'id' attribute and click it
        ...
        // Find the product elements with class '.mb-3' and store them into a List
        List<WebElement> products = driver.findElements(By.cssSelector(".mb-3"));

        // Use Java streams to find the WebElement with the text 'ZARA COAT 3'
        WebElement zaraCoat3 = products.stream()
                .filter(product -> product.findElement(By.cssSelector("h5 b")).getText().equalsIgnoreCase("ZARA COAT 3"))
                .findFirst()
                .orElse(null);
        if (zaraCoat3 != null) {
